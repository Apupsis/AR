/* دريفت بروبيشن — site behaviour */
(function () {
  'use strict';

  var P = 'header-velocity-track';
  var OPEN = 'is-open';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (toggle && menu) {
      ...
      window.addEventListener('resize', function () {
        if (window.innerWidth > 1050 && menu.classList.contains(OPEN)) close();
      });
    }

    /* cookie notice */
    var KEY = 'drift_promotion_cookie_consent';
