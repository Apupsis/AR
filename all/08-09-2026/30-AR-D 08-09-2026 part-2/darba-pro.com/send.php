...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $recipient_email = "support@darba-pro.com";
    $email_subject = "New Form Submission: " . htmlspecialchars($submission_subject);
    ...
    $email_body = "New form submission received:\n\n";
    ...
    $email_body .= "Subject: " . htmlspecialchars($submission_subject, ENT_QUOTES, 'UTF-8') . "\n";
    $email_body .= "Message:\n" . $sanitized_message . "\n\n";
    $email_body .= "Submission IP: " . $_SERVER['REMOTE_ADDR'] . "\n";
    ...
    $sanitized_recipient = filter_var($recipient_email, FILTER_SANITIZE_EMAIL);
    
    if (mail($sanitized_recipient, $email_subject, $email_body, $email_headers)) {
        header("Location: /thank/");
        exit;
    } else {
        header("Location: /thank/");
